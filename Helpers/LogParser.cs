...
namespace FACTOVA_LogAnalysis.Helpers
{
    public static class LogParser
    {
        ...
        // EVENT 로그를 파싱하는 정규식 - 실제로 로그 형식에 맞게 조정
        ...
        // ELEMENT 형식의 EVENT 로그를 파싱하는 새로운 정규식 추가
        ...
        // MSGID를 추출하는 정규식 - ELEMENT 형식에서 찾기
        ...
        private static string FormatTimestamp(string timestamp)
        {
            ...
            try
            {
                // 입력 형식: dd-MM-yyyy HH:mm:ss 를 yyyy-MM-dd HH:mm:ss
        ...
        private static string ExtractItemsFromEventContent(string content)
        {
            try
            {
                ...
                // 세 번째 시도: ELEMENT 부분 제외하고 나머지 반환
